...
ogr2ogr -f GeoJSON denue_09_25022015.json DENUE_INEGI_09_.shp -sql "SELECT nom_estab AS name, codigo_act AS activity, nom_vial+' '+numero_ext AS address, latitud, longitud FROM DENUE_INEGI_09_" -progress
